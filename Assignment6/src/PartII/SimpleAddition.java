...
public class SimpleAddition extends JFrame {
    ...
    public JPanel createContentPane (){
         ...
         * the current value
         */
        Adder adderOne = new Adder();
        addend1Field.addActionListener(adderOne);
        addend2Field.addActionListener(adderOne);
    ...
    private class Adder implements ActionListener {
        public void actionPerformed(ActionEvent event) {
            String num1 = addend1Field.getText();
            String num2 = addend2Field.getText();
            try {
                sumField.setText(Double.toString( Double.parseDouble(num1) + Double.parseDouble(num2)));
